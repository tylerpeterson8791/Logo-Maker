...
class Circle extends Shape {
    // Using constructor to assign the object properties. DO I NEED TO PULL EVERYTHING OR JUST logoShape?
    constructor(logoLetters, logoLettersColor, logoShape, logoColor) {
...
function createLogo(logoLetters, logoLettersColor, logoShape, logoColor) {
    console.log(logoLetters, logoLettersColor, logoShape, logoColor)
}
